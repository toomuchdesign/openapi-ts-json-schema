...
import { with$id as componentsSchemasPet } from "./components/schemas/Pet";
import { with$id as componentsSchemasPets } from "./components/schemas/Pets";
import { with$id as componentsSchemasError } from "./components/schemas/Error";
import { with$id as componentsSchemasOwner } from "./components/schemas/Owner";
