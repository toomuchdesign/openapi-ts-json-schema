 ...
 * @param options.moduleSystem - **Deprecated** — use `importExtension` instead. Ignored when `importExtension` is provided. `"esm"` maps to `importExtension: "js"`, `"cjs"` maps to `importExtension: "none"`.
